...
const navGroups: NavGroup[] = [
    ...
    },
    {
        label: 'AI Agents',
        items: [
            { name: 'Agents', path: '/admin/agents', icon: Icons.agent },
            { name: 'Task Chain Audit', path: '/admin/agents/audit', icon: Icons.agentAudit },
            { name: 'Webhooks', path: '/admin/agents/webhooks', icon: Icons.webhook },
        ],
    },
    {
