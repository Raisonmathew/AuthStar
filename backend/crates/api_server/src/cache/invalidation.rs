...
pub enum InvalidationScope {
    ...
    Capsule { tenant_id: String, action: String },

    /// Invalidate all capsules for a tenant
    TenantCapsules { tenant_id: String },
...
mod tests {
    ...
    fn test_invalidation_message_serialization() {
        ...
        // Deserialize back
        let deserialized = InvalidationMessage::from_json(&json).expect("Failed to deserialize");
    ...
    fn test_all_scope_types() {
        ...
        for scope in scopes {
            ...
            let json = msg.to_json().expect("Failed to serialize");
            let deserialized =
                InvalidationMessage::from_json(&json).expect("Failed to deserialize");
    ...
    fn test_message_without_reason() {
        let msg = InvalidationMessage::new(InvalidationScope::Global, "replica-1".to_string());
