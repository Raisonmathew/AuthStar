...
mod tests {
    ...
    fn test_high_risk_actions() {
        assert_eq!(
            ActionRiskLevel::from_action("org:delete"),
            ActionRiskLevel::High
        );
        assert_eq!(
            ActionRiskLevel::from_action("billing:transfer"),
            ActionRiskLevel::High
        );
        assert_eq!(
            ActionRiskLevel::from_action("device:unlock"),
            ActionRiskLevel::High
        );
        assert_eq!(
            ActionRiskLevel::from_action("user:delete"),
            ActionRiskLevel::High
        );
        assert_eq!(
            ActionRiskLevel::from_action("reset_password"),
            ActionRiskLevel::High
        );
    }
    ...
    fn test_medium_risk_actions() {
        assert_eq!(
            ActionRiskLevel::from_action("device:config"),
            ActionRiskLevel::Medium
        );
        assert_eq!(
            ActionRiskLevel::from_action("user:update"),
            ActionRiskLevel::Medium
        );
        assert_eq!(
            ActionRiskLevel::from_action("org:invite"),
            ActionRiskLevel::Medium
        );
        assert_eq!(
            ActionRiskLevel::from_action("policy:create"),
            ActionRiskLevel::Medium
        );
    }
    ...
    fn test_low_risk_actions() {
        assert_eq!(
            ActionRiskLevel::from_action("dashboard:read"),
            ActionRiskLevel::Low
        );
        assert_eq!(
            ActionRiskLevel::from_action("device:list"),
            ActionRiskLevel::Low
        );
        assert_eq!(
            ActionRiskLevel::from_action("user:get"),
            ActionRiskLevel::Low
        );
        assert_eq!(
            ActionRiskLevel::from_action("org:list"),
            ActionRiskLevel::Low
        );
    }
    ...
    fn test_internal_actions() {
        assert_eq!(
            ActionRiskLevel::from_action("internal:sync_users"),
            ActionRiskLevel::Internal
        );
        assert_eq!(
            ActionRiskLevel::from_action("service:health_check"),
            ActionRiskLevel::Internal
        );
        assert_eq!(
            ActionRiskLevel::from_action("batch:process_queue"),
            ActionRiskLevel::Internal
        );
    }
